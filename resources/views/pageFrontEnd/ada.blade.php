            ...
            <div class="col-md-3">
                <div class="row">
                    ...
                    <div class="content bg-light pt-5 pb-5 px-3">
                        ...
                        <div class="mb-4">
                            ...
                            <ul class="list-group">
                                ...
                                @if ($produk->bpom != 0)
                                    <li
                                        class="list-group-item d-flex justify-content-between align-items-center p-0 py-1 border-0">
                                        <span class="text-muted">Nomor Produk</span>
                        ...
                        <!-- Media Sosial -->
                        <div class="mb-3">
                            <div class="fw-bold text-center mb-3">Follow us!</div>
                            <ul class="list-group">
                                @foreach ($sosmed as $item)
                                    @switch($item->name)
                                        @case('Instagram')
                                            <li class="list-group-item d-flex align-items-center px-4 my-2 border rounded">
                                                <a href="{{ $item->link_sosmed }}" class="text-decoration-none" target="_blank">
                                        ...
                                        @case('Twitter')
                                            <li class="list-group-item d-flex align-items-center px-4 my-2 border rounded">
                                                <a href="{{ $item->link_sosmed }}" class="text-decoration-none"
                                                    target="_blank">
