...
@section('content')
    <div class="container" style="margin-top: 10%">
        <h1>Disclaimer for Labelin</h1>
        <p>If you require any more information or have any questions about our site's disclaimer, please feel free to
            contact us by email at admin@labelin.co</p>
        <h2>Disclaimers for Labelin</h2>
        <p>All the information on this website - https://labelin.co - is published in good faith and for general
            information purpose only. Labelin does not make any warranties about the completeness, reliability and
            accuracy of this information. Any action you take upon the information you find on this website (Labelin),
            is strictly at your own risk. Labelin will not be liable for any losses and/or damages in connection with
            the use of our website. Our Disclaimer was generated with the help of the <a
