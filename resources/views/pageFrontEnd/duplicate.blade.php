                ...
                <div class="row">
                    ...
                    <div class="gradient-main pt-5 pb-5">
                        ...
                        <div class="text-center text-light">
                            ...
                            <small>
                                Nomor Seri <strong>{{ $sn }}</strong> dengan Nama Produk
                                <strong>{{ $produk->nama_produk }}</strong><br> terduga mengalami duplikasi.
                            </small>
                        </div>
                    </div>
                    ...
                    <div class="content bg-light pt-5 pb-5 px-3">
                        ...
                        <div class="alert alert-danger d-flex rounded-4 mb-5"
                            ...
                            <small>Mohon maaf nomor seri dan produk terduga mengalami duplikasi. Waspada produk palsu
                                atau tiruan!</small>
                        </div>
                        ...
                        <div class="d-grid">
                            ...
                            <a href="https://wa.me/6281299903331?text=Saya%20mau%20melaporkan%20Serial%20Number%20{{ $sn }}%20dengan%20nama%20produk%20{{ $produk->nama_produk }}"
                                type="button" class="btn btn-block border" role="button" target="_blank">Hubungi
                                WhatsApp</a>
                        </div>
                        ...
                        <div class="row">
                            <div class="modal-content py-2" style="border-radius: 1rem;">
                                <div class="modal-body">
                                    ...
                                    <form id="form_report" class="mb-5" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mb-3">
        ...
        $(document).ready(function() {
            ...
            $('#form_report').submit(function(e) {
                ...
                $.ajax({
                    ...
                    error: function(res) {
                        alert(
                            'Tidak dapat melakukan report, silahkan muat ulang halaman dan laporkan kembali!')
                    }
                })
            })
        })
