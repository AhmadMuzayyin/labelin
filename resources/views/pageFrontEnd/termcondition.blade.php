...
@section('content')
    <div class="container" style="margin-top: 10%">
        ...
        <p>Welcome to Labelin!</p>
        <p>These terms and conditions outline the rules and regulations for the use of Labelin's Website, located at
            https://labelin.co.</p>
        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Labelin if
        ...
        <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
            ...
            taken as interchangeable and therefore as referring to same. Our Terms and Conditions were created with the
            help of the <a href="https://www.privacypolicyonline.com/terms-conditions-generator/">Terms & Conditions
                Generator</a>.</p>
        <h3><strong>Cookies</strong></h3>
        <p>We employ the use of cookies. By accessing Labelin, you agreed to use cookies in agreement with the Labelin's
            Privacy Policy.</p>
        ...
        <p>Unless otherwise stated, Labelin and/or its licensors own the intellectual property rights for all material
            on Labelin. All intellectual property rights are reserved. You may access this from Labelin for your own
            personal use subjected to restrictions set in these terms and conditions.</p>
        <p>You must not:</p>
        <ul>
            <li>Republish material from Labelin</li>
            <li>Sell, rent or sub-license material from Labelin</li>
            <li>Reproduce, duplicate or copy material from Labelin</li>
            <li>Redistribute content from Labelin</li>
        </ul>
        <p>This Agreement shall begin on the date hereof.</p>
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. Labelin does not filter, edit, publish or review Comments prior to their presence on
            the website. Comments do not reflect the views and opinions of Labelin,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, Labelin shall not be liable for the Comments or for any liability, damages or
        ...
        <p>Labelin reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant Labelin a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            Labelin; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to Labelin. Please include your name, your organization name,
        ...
        <p>No use of Labelin's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
