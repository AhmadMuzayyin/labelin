                ...
                <div class="row">
                    ...
                    <div class="content bg-light pt-5 pb-5 px-3">
                        ...
                        <div class="alert alert-danger d-flex rounded-4 mb-5"
                            ...
                            <svg class="bi flex-shrink-0 me-3 mt-1" width="16" height="16" viewBox="0 0 16 16"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M8.00001 0.00499725C3.58277 0.00499725 0.00500488 3.58276 0.00500488 8C0.00500488 12.4172 3.58277 15.995 8.00001 15.995C12.4172 15.995 15.995 12.4172 15.995 8C15.995 3.58276 12.4172 0.00499725 8.00001 0.00499725ZM7.00063 12.9969V10.9981H8.99938V12.9969H7.00063ZM7.00063 3.00312V9.99875H8.99938V3.00312H7.00063Z"
                                    fill="#DB2424" />
                            </svg>

                            <small>Mohon maaf nomor seri yang Anda cari tidak terdaftar pada produk manapun saat ini.
                                Waspada produk palsu atau tiruan!</small>
                        </div>

                        <!-- Tombol Pengaduan -->
                        <div class="d-grid">
                            <button type="button" class="btn text-light btn-block bg-main mb-3" data-bs-toggle="modal"
                                data-bs-target="#pengaduanModal">Pengaduan Produk</button>
                            <a href="https://wa.me/6281299903331?text=Hallo%20admin,%20saya%20ingin%20...."
                                type="button" class="btn btn-block border" target="_blank">Hubungi WhatsApp</a>
                        </div>
                        ...
                        <div class="row">
                            <div class="modal-content py-2" style="border-radius: 1rem;">
                                <div class="modal-body">
                                    ...
                                    <form id="form_report" class="mb-5" method="POST"
                                        ...
                                        <div class="mb-3">
                                            <label for="telp" class="form-label fw-medium">No. Telp</label>
                                            <input type="text" class="form-control" id="telp" name="telp"
                                                placeholder="no telp" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="kronologi" class="form-label fw-medium">Pengaduan /
                                                Kronologis</label>
                                            <textarea class="form-control" id="kronologi" name="kronologi" rows="3" placeholder="pengaduan kronologis"
                                                required></textarea>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="d-grid">
                                            <button type="submit" class="btn btn-main btn-block">Kirim
                                                Laporan</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form_report').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('produk_report', $sn) }}",
                    processData: false,
                    contentType: false,
                    data: formData,
                    success: function(res) {
                        $('#pengaduanModal').modal('hide');
                        alert('Success, terimakasih atas laporan anda!')
                    },
                    error: function(res) {
                        alert('Tidak dapat melakukan report, silahkan muat ulang halaman dan laporkan kembali!')
                    }
                })
            })
        })
